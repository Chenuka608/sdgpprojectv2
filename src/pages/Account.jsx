      ...
      <div className='bg-gray-100 flex flex-col justify-center'>
        <div className='max-w-[900px] w-full mx-auto bg-white p-8 mt-20 rounded-lg shadow-md grid grid-cols-1 sm:grid-cols-2 gap-4'>
          ...
          <div className="hidden sm:block"> {/* Hidden on small screens */}
            <img src="https://media.istockphoto.com/id/918803012/fr/vectoriel/informations-personnelles-ic%C3%B4ne-vector-illustration-isol%C3%A9-plat-caricature-du-symbole-de.jpg?s=612x612&w=0&k=20&c=8js5XxBQTVcGSGZN-RH1SmLOF57GXumIkyEBN7Eyw-0=" alt="User" className="mx-auto" style={{ width: '500px', height: '500px' }} />
          </div>
        </div>
      </div>
    </div>
